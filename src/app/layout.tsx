...
export default function RootLayout({
  ...
  return (
    <html lang="uk" className={`${cormorant.variable} ${jost.variable} h-full`}>
      <head>
        {/* Preload LCP hero images — mobile first, desktop via media */}
        <link rel="preload" as="image" href="/hero-mobile.webp" media="(max-width: 1023px)" />
        <link rel="preload" as="image" href="/bg-hero-n.webp" media="(min-width: 1024px)" />
